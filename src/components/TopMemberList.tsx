...
const TopMemberList = () => {
  return (
    <div className='flex flex-col gap-4 w-full md:w-1/2 m-auto'>
      <StaticImage src='../images/member/profile.jpg' alt='' width={192} className='w-1/3 mask mask-circle m-auto' />
      ...
      <div className='flex gap-2 m-auto'>
        ...
        <a href='https://qiita.com/mokichi' target='_blank'><StaticImage src='../images/devicon/qiita.png' alt='' width={32} className='mask mask-circle' /></a>
